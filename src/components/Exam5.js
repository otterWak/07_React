...
// JSX 예제 4 : 로그인 여부에 따라 화면 다르게 보이기 (t삼항 연산자)
const Exam5_4 = (props) => {
...
const Exam5_5 = (props) => {
  ...
  const listItmes = members.map( (mem, index) => <li key={index}>{mem}</li> );
  // [ <li>짱구</li>, <li>유리</li>, <li>철수</li>, <li>훈이</li>, <li>맹구</li> ]

  // Each child in a list should have a unique "key" prop
  // -> React에서 동적인 리스트를 렌더링 할 때
  //    각 자식 컴포넌트가 고유한 eky 속성을 가져야 한다는 규칙 위배시 발생하는 경고
  //    고유한 key 값 작성하면 경고 해결
